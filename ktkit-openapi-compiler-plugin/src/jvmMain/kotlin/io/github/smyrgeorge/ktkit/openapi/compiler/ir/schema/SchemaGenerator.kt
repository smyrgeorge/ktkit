...
import io.github.smyrgeorge.ktkit.openapi.compiler.ir.isNullableType
import io.github.smyrgeorge.ktkit.openapi.compiler.ir.schema.JsonNode.Companion.arr
    ...
    fun apiErrorRef(): JsonNode.Obj {
        if (API_ERROR_KEY !in components) {
            components[API_ERROR_KEY] = obj(
                ...
                "type" to str("object"),
                "properties" to obj(
                    "type" to obj("type" to arr(str("string"), str("null"))),
                    "title" to obj("type" to str("string")),
                    "status" to obj("type" to str("integer"), "format" to str("int32")),
                    "detail" to obj("type" to str("string")),
                    "requestId" to obj("type" to arr(str("string"), str("null"))),
                    "data" to obj(),
                ),
