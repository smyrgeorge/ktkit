package io.github.smyrgeorge.ktkit.openapi.compiler.utils
...
import io.github.smyrgeorge.ktkit.api.rest.openapi.OpenApiParam
import io.github.smyrgeorge.ktkit.api.rest.openapi.OpenApiResponse
...
class KtkitNamesTest {
    ...
    fun ktkitClassNamesMatchTheRuntime() {
        ...
        assertEquals(OpenApiParam::class.simpleName, KtkitNames.OPEN_API_PARAM)
        assertEquals(OpenApiResponse::class.simpleName, KtkitNames.OPEN_API_RESPONSE)
