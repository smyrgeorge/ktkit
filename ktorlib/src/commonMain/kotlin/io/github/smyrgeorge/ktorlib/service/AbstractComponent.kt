...
interface AbstractComponent {
    /**
     * Retrieves the [io.github.smyrgeorge.ktorlib.context.ExecutionContext] from the current CoroutineContext.
     *
     * @return The [io.github.smyrgeorge.ktorlib.context.ExecutionContext] if it exists within the current CoroutineContext.
     * @throws IllegalStateException if the [io.github.smyrgeorge.ktorlib.context.ExecutionContext] cannot be extracted from the CoroutineContext.
     */
